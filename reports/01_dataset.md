...
המאגר **מאוזן** למדי (≈54% חולים), כך שדיוק (accuracy) הוא מדד סביר להשוואת המודלים.
...
השלכנו את 13 המאפיינים לדו-ממד באמצעות **היטל אקראי של Johnson–Lindenstrauss** (הרצאה 15),
שמומש מאפס. ההיטל מראה הפרדה חלקית בין שתי הקבוצות — סימן שהבעיה ניתנת ללמידה
אך אינה ניתנת להפרדה לינארית מושלמת.

![Johnson–Lindenstrauss](../figures/projection_jl.png)
